...
const Shoes: React.FC = () => {
  ...
  const shoes = [
    { src: '/assets/shoe-1.webp', price: 'PKR 1,999' },
    { src: '/assets/shoe-2.webp', price: 'PKR 2,299' },
    { src: '/assets/shoe-3.webp', price: 'PKR 2,799' },
    { src: '/assets/shoe-4.webp', price: 'PKR 3,699' },
    { src: '/assets/shoe-5.webp', price: 'PKR 5,099' },
    { src: '/assets/shoe-6.webp', price: 'PKR 1,998' },
    { src: '/assets/shoe-7.webp', price: 'PKR 2,999' },
    { src: '/assets/shoe-8.webp', price: 'PKR 2,599' },
    { src: '/assets/shoe-9.webp', price: 'PKR 3,599' },
    { src: '/assets/shoe-10.webp', price: 'PKR 5,999' },
    { src: '/assets/shoe-11.webp', price: 'PKR 2,099' },
    { src: '/assets/shoe-12.webp', price: 'PKR 4,999' },
  ];

  return (
    <div className="p-10 bg-gradient-to-r from-blue-800 to-white">
      <h1 className="text-2xl font-bold mb-6 text-center">FootWear</h1>
